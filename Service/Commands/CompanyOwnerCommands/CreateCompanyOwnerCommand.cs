...
{
    public class CreateCompanyOwnerCommand : IRequest<CompanyOwner>
    {
        public CreateCompanyOwnerCommand(string? name, string? phoneNumber, string? password, string? emailAddress)
        {
            Name = name;
