...
{
    public class UpdateAdministratorCommand : IRequest<Administrator>
    {
        public UpdateAdministratorCommand(Guid id, string? name, string? phoneNumber, string? emailAddress, string? password)
        {
            Id = id;
            Name = name;
